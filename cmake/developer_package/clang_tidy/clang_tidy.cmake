...
function(ov_apply_clang_tidy)
    ...
    set(clang_tidy_options "--extra-arg=-Wno-unused-command-line-argument;--extra-arg=/EHsc")
    list(APPEND clang_tidy_options "--extra-arg=-Wno-unknown-warning-option;--export-fixes=clang_tidy_fixes_${TIDY_TARGET}.yaml")
