            ...
            if (batch_size.has_value()) {
                for (size_t i = 0; i < userTensor.size(); i++) {
                    ...
                    if (userBuffer != levelZeroBuffer) {
                        ...
                        const auto zeroBatchedTensorElementType =
                            get_level_zero_input(inputIndex, i)->get_element_type();
                        if ((zeroBatchedTensorElementType == ov::element::u8 &&
                            ...
                            get_level_zero_input(inputIndex, i)->set_element_type(userTensorElementType);
                        }
